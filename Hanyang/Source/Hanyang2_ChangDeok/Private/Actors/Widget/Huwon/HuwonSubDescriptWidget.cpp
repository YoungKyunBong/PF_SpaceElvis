...
void UHuwonSubDescriptWidget::NativeTick(const FGeometry& MyGeometry, float deltaTime)
{
...
void UHuwonSubDescriptWidget::SetTextToWidget(FString _text, double margin_Top, float _fontSize)
{
	text = _text;
...
void UHuwonSubDescriptWidget::ReverseWidgetAnim()
{
...
void UHuwonSubDescriptWidget::ResetWidgetAnim()
{
	AnimCurrTime = 0;
}

void UHuwonSubDescriptWidget::SetTextFont(float _fontSize)
{
