...
void UOejoSubDescriptWidget::NativeTick(const FGeometry& MyGeometry, float deltaTime)
{
...
void UOejoSubDescriptWidget::SetTextToWidget(FString _text, double margin_Top, float _fontSize)
{
	text = _text;
...
void UOejoSubDescriptWidget::ReverseWidgetAnim()
{
...
void UOejoSubDescriptWidget::ResetWidgetAnim()
{
	AnimCurrTime = 0;
}

void UOejoSubDescriptWidget::SetTextFont(float _fontSize)
{
