...
void UYeonJoSubDescriptWidget::NativeTick(const FGeometry& MyGeometry, float deltaTime)
{
...
void UYeonJoSubDescriptWidget::SetTextToWidget(FString _text, double margin_Top, float _fontSize)
{ 
	text = _text;
...
void UYeonJoSubDescriptWidget::ReverseWidgetAnim()
{
...
void UYeonJoSubDescriptWidget::ResetWidgetAnim()
{
	AnimCurrTime = 0;
}

void UYeonJoSubDescriptWidget::SetTextFont(float _fontSize)
{
