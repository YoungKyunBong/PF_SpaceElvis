...
#include "OejoWidgetActor.generated.h"

/**
 * 
 */
class ALevelScriptActor_Oejo;

UCLASS()
class HANYANG2_CHANGDEOK_API AOejoWidgetActor : public ADefaultManager
{
	GENERATED_BODY()
public:
...
private:
	...
	ALevelScriptActor_Oejo* LevelBP;
