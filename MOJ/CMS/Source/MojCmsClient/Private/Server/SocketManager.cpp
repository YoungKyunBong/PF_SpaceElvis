...
void SocketManager::Connect(FString ServerIP)
{
	if (ConnectionSocket == nullptr)
	{
		...
		{
			UE_LOG(LogTemp, Warning, TEXT("Fail Create Socket"));
		...
		if (!(*addr).IsValid())
		{
			UE_LOG(LogTemp, Warning, TEXT("Fail Create Addr"));
